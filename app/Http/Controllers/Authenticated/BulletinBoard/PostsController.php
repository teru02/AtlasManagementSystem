...
use App\Http\Requests\SubCategoryCreateFormRequest;
...
class PostsController extends Controller
{
    public function show(Request $request){
        ...
        if(!empty($request->keyword)){
            ...
            $posts = Post::with('user', 'postComments','subCategories')->whereHas('subCategories',function($q)use($sub_category){$q->where('sub_category',$sub_category);})->get();
    ...
    public function postCreate(PostFormRequest $request){
        ...
        $post->subCategories()->attach($request->get('post_category_id',[]));
    ...
    public function subCategoryCreate(SubCategoryCreateFormRequest $request){
        SubCategory::create([
